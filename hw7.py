...
def rect_perimeter(r):
    return 2*r.width + 2*r.height

type_tags = {Square: 'square', Rect: 'rect'}
...
def apply(operator_name, shape):
    ...
    apply_implementations = {('area', 'square'): square_area, ('area', 'rect'): rect_area, ('perimeter', 'square'): square_perimeter, ('perimeter','rect'): rect_perimeter}
